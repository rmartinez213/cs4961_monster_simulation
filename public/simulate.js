...
socket.on("simulated-data", function(data) {
  ...
  document.write(
    '<px-map-marker-static id="Godzilla" style="display:none;" lat="-44.245866" lng="-13.772970" type="info"> <px-map-popup-data title="Godzilla" data=\'{"Kills":"2000","damage":"etc","magnitude":"8.0"}\'> </px-map-popup-data> </px-map-marker-static>'
  );
});
